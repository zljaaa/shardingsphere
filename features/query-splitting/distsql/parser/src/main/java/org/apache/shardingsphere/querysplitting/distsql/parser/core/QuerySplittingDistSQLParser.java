...
/**
 * SQL parser for query-splitting DistSQL.
 */
public final class QuerySplittingDistSQLParser extends QuerySplittingDistSQLStatementParser implements SQLParser {
    
    public QuerySplittingDistSQLParser(final TokenStream input) {
        super(input);
    }
