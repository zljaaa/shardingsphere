...
package org.apache.shardingsphere.querysplitting.distsql.parser.segment;
...
@Getter
public final class QuerySplittingRuleSegment implements ASTNode {
    ...
    public QuerySplittingRuleSegment(final String name, final String autoAwareResource, final String writeDataSourceQueryEnabled, final String loadBalancer, final Properties props) {
        this(name, autoAwareResource, writeDataSourceQueryEnabled, null, null, loadBalancer, props);
    }
    
    public QuerySplittingRuleSegment(final String name, final String writeDataSource, final Collection<String> readDataSources, final String loadBalancer, final Properties props) {
