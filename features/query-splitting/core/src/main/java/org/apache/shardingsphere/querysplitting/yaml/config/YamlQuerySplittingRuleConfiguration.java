...
package org.apache.shardingsphere.querysplitting.yaml.config;
...
@Getter
@Setter
public final class YamlQuerySplittingRuleConfiguration implements YamlRuleConfiguration {
    
    private Map<String, YamlQuerySplittingDataSourceRuleConfiguration> dataSources = new LinkedHashMap<>();
    
    private Map<String, YamlAlgorithmConfiguration> loadBalancers = new LinkedHashMap<>();
    
    @Override
    public Class<QuerySplittingRuleConfiguration> getRuleConfigurationType() {
